      ...
      <v-row align-content="center">
        ...
        <v-col cols="10">
          ...
          <ol>
            ...
            <li>当社ウェブサイトの滞在時間、入力履歴等の当ウェブサイトにおけるお客様の行動履歴</li>
            <li>当アプリの起動時間、入力履歴等の当アプリの利用履歴</li>
          </ol>
          <h2>お客様の情報を利用する目的</h2>
          <p>
          ...
          <li>当社サービスの変更、提供中止、終了をご連絡するため</li>
          ...
          <p>
            <a href="mailto:myfavoritealbumsdev@gmail.com"></a>
          </p>
          <p>この場合、必ず、運転免許証のご提示等当社が指定する方法により、ご本人からのご請求であることの確認をさせていただきます。なお、情報の開示請求については、開示の有無に関わらず、ご申請時に一件あたり1</p>
          <br>
          以上<br><br>
          2022年08月07日 制定<br>
        </v-col>
